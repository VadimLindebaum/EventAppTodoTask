  ...
  return (
    <>
      ...
      <Typography variant="caption" sx={{ display: "block", mt: 2 }}>
        Created by <Link href="https://github.com/VadimLindebaum">Code</Link> <br />
        Explore the project on GitHub:{" "}
        <Link href="https://github.com/VadimLindebaum/EventAppTodoTask" target="_blank" rel="noopener noreferrer">
          Todo App Repository
        </Link>
      </Typography>
